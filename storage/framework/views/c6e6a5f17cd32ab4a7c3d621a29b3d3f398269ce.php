                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                   ...
                                   <p class="text-muted mb-0">Customer/Staff</p>
                                </div>
                            </div>
                        </li>
            ...
            if(order_id!=0)
            {
                ...
                success: function(result) {
                    ...
                    if(result.data.orders)
                    {
                        ...
                        {
                        //    $('#customer_name').text(result.data.customer.name);
                           $('#customer_email').text(result.data.staff.email);
                        }
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="${file_url}${el.image}" alt="" class="img-fluid d-block w-100 h-100">
                                            </div>
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15">${el.product_name}</h5>
                                           </div>
                                        </div>
                                    </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rms\resources\views/orders_details.blade.php ENDPATH**/ ?>