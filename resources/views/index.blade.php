    ...
    <div class="col">
        ...
        <div class="h-100">
                        ...
                        {{-- <div class="mt-3 mt-lg-0">
                            <form action="javascript:void(0);">
                                <div class="row g-3 mb-0 align-items-center">
                                    ...
                                    <!--end col-->
                                    <div class="col-auto">
                                        <a  class="btn btn-soft-success" href="{{url('/add_product')}}"><i class="ri-add-circle-line align-middle me-1"></i>
                                            Add Product</a>
                                    </div>
                                    <!--end col-->
                                    <div class="col-auto">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    ...
                                    <a href="{{url('/orders_billed')}}" class="text-decoration-underline">View net
                                        earnings</a>
                                </div>
                ...
                <div class="col-xl-3 col-md-6" id="orders_div">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="1" id="orders_count">0</span></h4>
                                    <a href="{{url('/orders_billed')}}" class="text-decoration-underline">View all orders</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    ...
                                    <a href="{{url('/product')}}" class="text-decoration-underline">View All Menu</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-xl-3 col-md-6" id="sellers_div" style="display:{{Auth::user()->role==1 ? 'block':'none'}};">
                    <!-- card -->
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    ...
                                    <a href="{{url('/sellers')}}" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
            ...
            <div class="row" style="display:{{Auth::user()->role==1 ? 'block':'none'}};">
                <div class="col-lg-12">
                    <div class="card">
